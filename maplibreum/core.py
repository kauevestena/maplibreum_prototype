...
class Map:
    ...
    def __init__(
        ...
        if "projection" in self.additional_map_options and isinstance(
            self.additional_map_options["projection"], str
        ):
            self.additional_map_options["projection"] = {
                "name": self.additional_map_options["projection"]
            }
