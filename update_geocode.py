content = open('tests/test_examples/test_geocode_with_nominatim.py').read()
if "test_geocode_with_nominatim_with_python_api" not in content:
    with open('tests/test_examples/test_geocode_with_nominatim.py', 'w') as f:
        f.write(content + """
