...
- [x] `tests/test_examples/test_disable_map_rotation.py`
- [x] `tests/test_examples/test_animate_map_camera_around_a_point.py`
- [x] `tests/test_examples/test_add_a_custom_layer_with_tiles_to_a_globe.py`
- [x] `tests/test_examples/test_add_a_3d_model_using_threejs.py`
- [x] `tests/test_examples/test_pmtiles_source_and_protocol.py`
- [x] `tests/test_examples/test_sync_movement_of_multiple_maps.py`
- [x] `tests/test_examples/test_add_a_video.py`
- [x] `tests/test_examples/test_create_a_hover_effect.py`
- [x] `tests/test_examples/test_fly_to_a_location.py`
- [x] `tests/test_examples/test_zoom_and_planet_size_relation_on_globe.py`
- [x] `tests/test_examples/test_create_deckgl_layer_using_rest_api.py`
- [x] `tests/test_examples/test_fit_to_the_bounds_of_a_linestring.py`
- [x] `tests/test_examples/test_geocode_with_nominatim.py`
- [x] `tests/test_examples/test_get_features_under_the_mouse_pointer.py`
- [x] `tests/test_examples/test_adding_3d_models_using_threejs_on_terrain.py`
- [x] `tests/test_examples/test_animate_a_point_along_a_route.py`
- [x] `tests/test_examples/test_filter_layer_symbols_using_global_state.py`
- [x] `tests/test_examples/test_add_a_3d_model_to_globe_using_threejs.py`
- [x] `tests/test_examples/test_get_coordinates_of_the_mouse_pointer.py`
- [x] `tests/test_examples/test_jump_to_a_series_of_locations.py`
- [x] `tests/test_examples/test_slowly_fly_to_a_location.py`
- [x] `tests/test_examples/test_measure_distances.py`
- [x] `tests/test_examples/test_offset_the_vanishing_point_using_padding.py`
- [x] `tests/test_examples/test_navigate_the_map_with_game_like_controls.py`
- [x] `tests/test_examples/test_customize_camera_animations.py`
