...
def test_display_line_that_crosses_180th_meridian():
    ...
    assert route_label_layer['definition']['layout']['text-field'] == 'Crosses the world'
    assert route_label_layer['definition']['layout']['symbol-placement'] == 'line-center'
    ...
    assert route_two_label_layer['definition']['layout']['text-field'] == 'Crosses 180th meridian'
    assert route_two_label_layer['definition']['layout']['symbol-placement'] == 'line-center'
