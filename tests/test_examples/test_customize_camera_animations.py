...
def test_customize_camera_animations_with_python_api():
    ...
    panel = PanelControl(
        ...
        js_content=overlay_js,
        css_class="map-overlay top"
    )
    m.add_control(panel)
    ...
    assert "map.setLayoutProperty(\n" in html or "map.setLayoutProperty(" in html
    assert "easeInCubic" in html
